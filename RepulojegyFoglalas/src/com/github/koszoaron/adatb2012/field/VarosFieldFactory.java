...
public class VarosFieldFactory implements FormFieldFactory {
    private static final long serialVersionUID = 1L;

    public Field createField(Item item, Object propertyId, Component uiContext) {
        String pid = (String)propertyId;
        
        if (pid.equals(Constants.VAROS_ID_POJO)) {
            return new TextField(Constants.VAROS_ID_POJO);
        } else if (pid.equals(Constants.VAROSNEV)) {
            return new TextField(Constants.VAROSNEV);
